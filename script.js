...
const game = {
  ...
  stats: {
    ...
    ATAQUE:   { level:1, value:5,    xp:0, xpNext:95,  gain:3,    xpGrowth:1.19 },
    CRITICO:  { level:1, value:0.15, xp:0, xpNext:130, gain:0.15, xpGrowth:1.22 },
    DEFENSA:  { level:1, value:5,    xp:0, xpNext:145, gain:3,    xpGrowth:1.26 },
    HP:       { level:1, value:30,   xp:0, xpNext:180, gain:12,   xpGrowth:1.30 },
    VELOCIDAD:{ level:1, value:4,    xp:0, xpNext:220, gain:2,    xpGrowth:1.50 },
    EVASION:  { level:1, value:0.15, xp:0, xpNext:210, gain:0.15, xpGrowth:1.50 }
  }
};
