...
function computeGPS() {
  ...
  base *= window.AttrsFeature.getDamageMultiplier();
  return base;
}
...
function saveGame() {
  const save = {
    ...
    attrFeature: window.AttrsFeature.getSaveData(),
...
function loadGame() {
  try {
    ...
    if (save.attrFeature) window.AttrsFeature.loadFromSave(save.attrFeature);
...
function renderAttrsModal() {
  return window.AttrsFeature.renderAttrsModal(G);
}

function buyFiloCarbonoUpgrade() {
  return window.AttrsFeature.buyFiloCarbonoUpgrade(G, showToast, updateUI, openModal);
}
...
window.buyFiloCarbonoUpgrade = buyFiloCarbonoUpgrade;
