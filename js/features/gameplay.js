...
function computeGPS() {
  ...
  if (window.ATTR_BUTTON_STATE?.carbonEdgeMultiplier) base *= window.ATTR_BUTTON_STATE.carbonEdgeMultiplier;
...
function saveGame() {
  const save = {
    ...
    ATTR_BUTTON_STATE: window.ATTR_BUTTON_STATE ? { ...window.ATTR_BUTTON_STATE } : null,
...
function loadGame() {
  try {
    ...
    if (save.ATTR_BUTTON_STATE && window.ATTR_BUTTON_STATE) Object.assign(window.ATTR_BUTTON_STATE, save.ATTR_BUTTON_STATE);
...
function renderModal(type) {
  switch(type) {
    ...
    case 'attrs': return window.renderAttrsModal ? window.renderAttrsModal() : '<p>Próximamente...</p>';
