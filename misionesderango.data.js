...
const misionesderango2MissionsData = {
    D: [
      { name: "Eliminar lobos hambrientos", xp: 3, gold: 5, hp: 60, atk: 15, def: 7, lvl: 1 },
      { name: "Recuperar suministros robados por goblins", xp: 5, gold: 8, hp: 110, atk: 23, def: 18, lvl: 3 },
      { name: "Proteger la aldea de jabalíes", xp: 9, gold: 15, hp: 210, atk: 32, def: 29, lvl: 5 },
      { name: "Investigar ruinas infestadas de ratas gigantes", xp: 15, gold: 35, hp: 290, atk: 48, def: 30, lvl: 7 },
      { name: "Escoltar a un mercader (bandido)", xp: 19, gold: 58, hp: 364, atk: 57, def: 35, lvl: 9 },
      { name: "Cazar una bestia nocturna", xp: 25, gold: 70, hp: 482, atk: 66, def: 41, lvl: 12 }
    ],
    C: [
  ...
  md2.misionesderango2MissionsData = misionesderango2MissionsData;
